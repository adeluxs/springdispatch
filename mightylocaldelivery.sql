...
CREATE TABLE `cities` (
  ...
  `admin_commission` double NULL DEFAULT '0', 
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(25, '2022_12_05_111707_alter_cities_table', '6'),
(26, '2022_12_05_140929_create_wallets_table', '6'),
(27, '2022_12_05_140954_create_wallet_histories_table', '6'),
(28, '2022_12_05_141107_create_user_bank_accounts_table', '6'),
(29, '2022_12_06_061753_alter_payments_table', '6'),
(30, '2022_12_10_054128_create_withdraw_requests_table', '6'),
(31, '2023_01_30_121805_create_vehicles_table', '7'),
(32, '2023_01_30_131633_add_is_vehicle_in_order_in_app_settings_table', '7'),
(33, '2023_01_30_132224_add_vehicle_data_in_orders_table', '7'),
(34, '2023_05_05_111042_create_settings_table', '8'),
(35, '2023_05_19_100843_add_otp_verify_at_in_users_table', '8'),
(NULL, '2023_05_22_101819_create_user_addresses_table', '9'),
(NULL, '2023_06_30_054429_create_verification_codes_table', '9'),
(NULL, '2023_07_06_114913_add_login_type_in_users_table', '9');
...
CREATE TABLE `payments` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `cancel_charges` double NULL DEFAULT '0',
  `admin_commission` double NULL DEFAULT '0',
  `delivery_man_commission` double NULL DEFAULT '0',
  `received_by` VARCHAR(255) NULL DEFAULT NULL,
  `delivery_man_fee` double NULL DEFAULT '0',
  `delivery_man_tip` double NULL DEFAULT '0',
  PRIMARY KEY (`id`),
